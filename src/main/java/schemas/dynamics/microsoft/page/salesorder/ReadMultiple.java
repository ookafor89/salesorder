 ...
 *       &lt;sequence&gt;
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/salesorder}salesorder_Filter" maxOccurs="unbounded"/&gt;
...
public class ReadMultiple {
    ...
    protected List<SalesorderFilter> filter;
     ...
     * {@link SalesorderFilter }
     * 
     * 
     */
    public List<SalesorderFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<SalesorderFilter>();
        }
        return this.filter;
    }
